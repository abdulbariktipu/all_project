            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <?php //if($access==1){?>       
                        <div class="col-md-4">
                          <a href="user_register.php" class="btn btn-success btn-lg" class="bwidth" role="button"><span class="glyphicon glyphicon-user"></span> <br/>Registration</a>
                         </div> 
                          <?};?>
                        <div class="col-md-4">
                          <a href="#" class="btn btn-info btn-lg" role="button"><span class="glyphicon glyphicon-user"></span> <br/>Admin Panel</a>                          
                        </div>
                        
                        <div class="col-md-4">
                           <a href="#" class="btn btn-success btn-lg" role="button"><span class="glyphicon glyphicon-user"></span> <br/>All User</a>
                        </div>                   
                    </div>
                </div>
