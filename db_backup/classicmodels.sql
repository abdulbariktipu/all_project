...
MySQL - 10.1.26-MariaDB : Database - classicmodels
*********************************************************************
*/
...
(103,'Tipu','Schmitt','Carine ','40.32.2555','K-45/1, Kalachadpur','Level 6','Dhaka',NULL,'44000','Bangladesh',1370,21000.00),
...
(1002,'Tipu','Diane','x5800','dmurphy@classicmodelcars.com','1',1002,'President'),
...
/*Table structure for table `employesalary` */
...
CREATE TABLE `employesalary` (
  ...
  KEY `employeNumber` (`employeNumber`),
  CONSTRAINT `employesalary_ibfk_1` FOREIGN KEY (`employeNumber`) REFERENCES `employees` (`employeeNumber`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `employesalary` */

insert  into `employesalary`(`salary_id`,`salary`,`employeNumber`) values 
(1,'20000',1002),
(2,'30000',1056),
(3,'40000',1076);

/*Table structure for table `insertformanothertable` */

DROP TABLE IF EXISTS `insertformanothertable`;

CREATE TABLE `insertformanothertable` (
  `officeCode` int(30) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`officeCode`,`addressLine1`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

/*Data for the table `insertformanothertable` */

insert  into `insertformanothertable`(`officeCode`,`city`,`phone`,`addressLine1`,`addressLine2`,`state`,`country`,`postalCode`,`territory`) values 
(1,'Dhaka','+1 650 219 4782','100 Market Street','Suite 300','CA','USA','94080','NA'),
(2,'Gazipur','+1 215 837 0825','1550 Court Place','Suite 102','MA','USA','02107','NA'),
(3,'Gulshan','+1 212 555 3000','523 East 53rd Street','apt. 5A','NY','USA','10022','NA'),
...
/*Table structure for table `machin_entry` */

DROP TABLE IF EXISTS `machin_entry`;

CREATE TABLE `machin_entry` (
  `id` int(11) NOT NULL,
  `location_id` int(11) DEFAULT NULL,
  `floor_id` int(11) DEFAULT NULL,
  `machin_capacity` int(100) DEFAULT NULL,
  `company_id` int(11) DEFAULT NULL,
  `remarks` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `machin_entry` */

insert  into `machin_entry`(`id`,`location_id`,`floor_id`,`machin_capacity`,`company_id`,`remarks`) values 
(100,111,123,5000,1,'MC'),
(101,111,123,2000,2,NULL),
(102,112,124,3000,3,NULL);

/*Table structure for table `machin_idle_mst` */

DROP TABLE IF EXISTS `machin_idle_mst`;

CREATE TABLE `machin_idle_mst` (
  `id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  `floor_id` int(11) DEFAULT NULL,
  `machin_name` varchar(50) NOT NULL,
  `machin_id` int(11) NOT NULL,
  `from_date` date DEFAULT NULL,
  `from_hour` varchar(10) DEFAULT NULL,
  `from_minute` varchar(10) NOT NULL,
  `to_date` date NOT NULL,
  `to_hour` varchar(10) NOT NULL,
  `to_minute` varchar(10) DEFAULT NULL,
  `company_id` int(11) DEFAULT NULL,
  `remarks` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `machin_idle_mst` */

insert  into `machin_idle_mst`(`id`,`location_id`,`floor_id`,`machin_name`,`machin_id`,`from_date`,`from_hour`,`from_minute`,`to_date`,`to_hour`,`to_minute`,`company_id`,`remarks`) values 
(1,111,123,'MC-01',100,'2019-07-04','11','10','2019-07-04','11','50',1,'Test 1'),
(2,111,123,'MC-01',100,'2019-07-04','12','20','2019-07-04','12','50',1,'Test 2'),
(3,112,124,'MC-02',102,'2019-07-05','10','30','2019-07-06','11','15',2,'Test 3');
...
('2','Gazipur','+1 215 837 0825','1550 Court Place','Suite 102','MA','USA','02107','NA'),
('3','Gulshan','+1 212 555 3000','523 East 53rd Street','apt. 5A','NY','USA','10022','NA'),
('4','Mirpur','+33 14 723 4404','43 Rue Jouffroy D\'abbans',NULL,NULL,'France','75017','EMEA'),
('5','Naogaon','+81 33 224 5000','4-1 Kioicho',NULL,'Chiyoda-Ku','Japan','102-8578','Japan'),
('6','Gupalganj','+61 2 9264 2451','5-11 Wentworth Avenue','Floor #2',NULL,'Australia','NSW 2010','APAC'),
('7','Nator','+44 20 7877 2041','25 Old Broad Street','Level 7',NULL,'UK','EC2N 1HN','EMEA');
...
(103,'JM555205','2003-06-05',6066.78),
...
('Motorcycles','Our motorcycles are state of the art replicas of classic as well as contemporary motorcycle legends such as Harley Davidson, Ducati and Vespa. Models contain stunning details such as official logos, rotating wheels, working kickstand, front suspension, gear-shift lever, footbrake lever, and drive chain. Materials used include diecast and plastic. The models range in size from 1:10 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. All models come fully assembled and ready for display in the home or office. Most include a certificate of authenticity.','د؇6Exif',NULL),
...
insert  into `suppliers`(`id`,`supplierName`,`phone`,`addressLine1`,`addressLine2`,`city`,`state`,`postalCode`,`country`,`customerNumber`) values 
(1,'Mini Gifts Distributors Ltd.',2147483647,'5677 Strong St.',NULL,'San Rafael','CA',97562,'USA',124),
(2,'Mini Wheels Co.',2147483647,'5557 North Pendale Street',NULL,'San Francisco','CA',94217,'USA',129),
(3,'Technics Stores Inc.',2147483647,'9408 Furth Circle',NULL,'Burlingame','CA',94217,'USA',161),
(4,'Toys4GrownUps.com',2147483647,'78934 Hillside Dr.',NULL,'Pasadena','CA',90003,'USA',205),
(5,'Boards & Toys Co.',2147483647,'4097 Douglas Av.',NULL,'Glendale','CA',92561,'USA',219),
(6,'Collectable Mini Designs Co.',2147483647,'361 Furth Circle',NULL,'San Diego','CA',91217,'USA',239),
(7,'Corporate Gift Ideas Co.',2147483647,'7734 Strong St.',NULL,'San Francisco','CA',94217,'USA',321),
(8,'Men \'R\' US Retailers, Ltd.',2147483647,'6047 Douglas Av.',NULL,'Los Angeles','CA',91003,'USA',347),
(9,'The Sharp Gifts Warehouse',2147483647,'3086 Ingle Ln.',NULL,'San Jose','CA',94217,'USA',450),
(10,'West Coast Collectables Co.',2147483647,'3675 Furth Circle',NULL,'Burbank','CA',94019,'USA',475),
(11,'Signal Collectibles Ltd.',2147483647,'2793 Furth Circle',NULL,'Brisbane','CA',94217,'USA',487);
...
/*!50001 DROP TABLE IF EXISTS `temporary` */;

/*!50001 CREATE TABLE  `temporary`(
 `officeCode` int(30) ,
 `city` varchar(30) ,
 `phone` varchar(30) 
)*/;
...
/*View structure for view temporary */

/*!50001 DROP TABLE IF EXISTS `temporary` */;
/*!50001 DROP VIEW IF EXISTS `temporary` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `temporary` AS select `insertformanothertable`.`officeCode` AS `officeCode`,`insertformanothertable`.`city` AS `city`,`insertformanothertable`.`phone` AS `phone` from `insertformanothertable` order by `insertformanothertable`.`officeCode` desc */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `test` AS select `insertformanothertable`.`officeCode` AS `officeCode`,`insertformanothertable`.`city` AS `city`,`insertformanothertable`.`phone` AS `phone` from `insertformanothertable` order by `insertformanothertable`.`officeCode` desc */;
