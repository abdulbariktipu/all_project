...
<body>
	<div id="body">
		...
		<div class="container">
		    ...
		    <p class="footer"><span id="mycsscolor">Page rendered in </span><strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?>
