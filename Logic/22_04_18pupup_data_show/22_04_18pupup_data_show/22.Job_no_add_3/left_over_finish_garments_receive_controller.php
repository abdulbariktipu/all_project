...
{
	echo create_drop_down( "cbo_store_name", 172, "select id,store_name from lib_store_location  where id='$data' order by store_name", "id,store_name", 1, "-- Select Store --", $selected, 0, "" );
}
/**
...
//var_dump($order_type); die();
	if($order_type==2){
//var_dump($order_type); die();
		$sql= "select a.order_no,a.cust_style_ref,a.cust_buyer, b.company_id from subcon_ord_dtls a, subcon_ord_mst b where a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and b.company_id= $company";
