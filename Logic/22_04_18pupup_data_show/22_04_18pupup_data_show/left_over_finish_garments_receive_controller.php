...
if($action=="create_po_search_list_view")
{
	...
	{	
	   ...
	   $sql= "select a.ship_mode,b.po_number from wo_po_details_master a, wo_po_break_down b  where a.job_no=b.job_no_mst and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and a.company_name= $company and a.ship_mode=3" ;
     ...
     <div style="width:900px; max-height:240px;overflow-y:scroll;" >	 
        <table cellspacing="0" cellpadding="0" border="1" rules="all" width="1172" class="rpt_table" id="tbl_po_list">
			...
			<tr>
				...
				<td width="100"><? echo $row[csf('ship_mode')]; ?></td>
