...
{
	echo create_drop_down( "cbo_location_name", 172, "select id,location_name from lib_location where status_active =1 and is_deleted=0 and company_id='$data' order by location_name","id,location_name", 1, "-- Select Location --", $selected, 0, "load_drop_down( 'requires/left_over_finish_garments_receive_controller', this.value, 'load_drop_down_store_name', 'store_name' ), load_drop_down( 'requires/left_over_finish_garments_receive_controller', this.value, 'load_drop_down_floor', 'floor_name' )" );     	 
}

if ($action=="load_drop_down_store_name")
{
	echo create_drop_down( "cbo_store_name", 172, "select id,store_name from lib_store_location where status_active =1 and is_deleted=0 and id='$data' order by store_name","id,store_name", 1, "-- Select Location --", $selected, 0, "" );
}
