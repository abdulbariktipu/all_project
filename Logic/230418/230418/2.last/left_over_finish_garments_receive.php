...
function openmypage(page_link,title)
{
	...
	else
	{
		...
		emailwindow.onclose=function()
		{
			...
			var buyer_name=this.contentDoc.getElementById("hidden_cbo_buyer_name").value;	
                    ...
                    <table width="100%" border="0">
                        <tr>
                          ...
                          <!-- <td width="" class="must_entry_caption">Iron Company</td>
							...
							<td width="">Buyer</td>
                            <td width="170">
                            	<input type="hidden" id="hidden_cbo_buyer_name" name="hidden_cbo_buyer_name" value="b" >
                            	<input type="text" id="dd" name="dd" value="">
								<!-- <? 
                                //echo create_drop_down( "cbo_buyer_name", 170, "select id,buyer_name from lib_buyer where is_deleted=0 and status_active=1 order by buyer_name","id,buyer_name", 1, "-- Select Buyer --", $selected, "",0,0 );
                                ?> -->
							</td>
