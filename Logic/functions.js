...
function file_uploader ( url, mst_id, det_id,  form, file_type, is_multi, show_button,sttc_name )
{
...
function print_priview_html( report_div, scroll_div, header_table, footer_table, report_type, link_pos, rel_path, extra_func, top_table )  //type: 1=xls, 2=pdf, 3=html
{
	var filter=0;
