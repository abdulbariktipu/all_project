...
function openmypage(page_link,title)
{
	...
	else
	{
		...
		emailwindow.onclose=function()
		{
			...
			var exchange_rate_hidden=this.contentDoc.getElementById("hidden_currency_rate").value;
			...
			if (po_id!="")
			{
				...
				$("#exchange_rate_hidden").val(exchange_rate_hidden);			
				
				check_exchange_rate(exchange_rate_hidden);
 ...
 function left_over_amount(left_over_value){
 	//alert(left_over_value);
 	//Laftover Amount = (Total Left Over Receive *  FOB Rate);
 	var left_over = $('#txt_fob_rate').val()*left_over_value;
 	//alert(left_over);
 	$('#txt_leftover_amount').val(left_over);

 	//bdt_amount = (Exchange_rate *  Laftover Amount);
 	var bdt_amount = $('#exchange_rate').val()*$('#txt_leftover_amount').val();
...
function check_exchange_rate(curr_id)
	{
		var cbo_currercy=curr_id;//$('#exchange_rate_hidden').val()
		var booking_date = $('#txt_iron_date').val();
		var response=return_global_ajax_value( cbo_currercy+"**"+booking_date, 'check_conversion_rate', '', 'requires/left_over_finish_garments_receive_controller');
                        ...
                        <tr>
                          ...
                          <!-- <td width="" class="must_entry_caption">Iron Company</td>
                            ...
                            <td width="170">
                            	...
                            	<input type="hidden" name="exchange_rate_hidden" id="exchange_rate_hidden" class="text_boxes" style="width:160px " readonly>
							</td>
                            ...
                            <legend>New Entry</legend>
                                 <table  cellpadding="0" cellspacing="2" width="100%">
                                    ...
                                    <tr>
                                         ...
                                         <td>
                                           <input type="text" name="txt_total_left_over_receive" id="txt_total_left_over_receive" class="text_boxes" style="width:100px" onKeyUp="left_over_amount(this.value)" />
                                         </td>
                                    </tr>
                                    <tr>
                                    	<td width="">Remarks</td> 
                                ...
                                <table  cellpadding="0" cellspacing="2" width="100%" >
                                	<tr>
                                        ...
                                        <td>
                                         ...
                                         <input type="hidden" name="hidden_currency" id="hidden_currency_rate" value="" class="text_boxes" style="width:80px"  />
                                        </td>
                                    </tr>
                                    <tr>
