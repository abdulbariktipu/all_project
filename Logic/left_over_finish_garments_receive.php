...
$order_type = array('Self Order'*'Subcontract Order');
$order_values = array('1'*'2');

$goods_type = array('A'*'B'*'C');
$goods_values = array('1'*'2'*'3');
                        ...
                        <tr>
							...
							<td width="" id="locations">Location</td>
                             <td width="" id="location">
								 <?
                                 echo create_drop_down( "cbo_store_name", 170, $blank_array, "",1, "-- Select Location --", $selected, "" );
                                 ?>
							 </td>
							...
							<td width="120" class="must_entry_caption">Date</td>
                             <td width=""> 
                              	<input name="txt_iron_date" id="txt_iron_date" class="datepicker" type="text" value="" style="width:100px;"  />
                            </td>
                            ...
                            <td width="170" id="order_type">
                            	<? 
                                   echo create_drop_down( "cbo_order_type", 170, $blank_array, "",1, "-- Select Order Type--", $selected, "", "", "", "$order_type", "$order_values" );
                                  ?>
							</td>
							<td width="">Buyer</td>
                            <td width="170">
                    ...
                    <tr>
                            ...
                            <legend>New Entry</legend>
                                 <table  cellpadding="0" cellspacing="2" width="100%">
                                    	<tr>
                                            <td width="120">Goods Type</td>
                                             <td width="" id="goods_type"> 
                                              	<? 
                                					echo create_drop_down( "cbo_goods_type", 170, $blank_array, "",1, "-- Select Store --", $selected, "", "", "", "$goods_type", "$goods_values" );
                                				?>
                                            </td>
                                    	</tr>
                                         <tr>
                                     ...
                                     <tr>  
                                         ...
                                         <td width=""> 
                                            <input name="txt_style_name" id="txt_style_name" class="text_boxes"  style="width:100px" />
                                        </td>
                                    </tr>
                                     <tr>  
                                         <td width="">Item Name</td> 
                                         <td width=""> 
                                            <input name="txt_item_name" id="txt_item_name" class="text_boxes"  style="width:100px" />
                                        </td>
                                    </tr>
                                    <tr>  
                                         <td width="">Country</td> 
                                         <td width=""> 
                                            <input name="txt_country" id="txt_country" class="text_boxes"  style="width:100px" type="text" />
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <td width="25%" valign="top">
                            ...
                            <legend>Display</legend>
                                <table  cellpadding="0" cellspacing="2" width="100%" >
                                    <tr>
                                        <td width="140" id="fob_rate">FOB rate</td>
                                        <td>
