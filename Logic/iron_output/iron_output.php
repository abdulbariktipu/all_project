  				...
  				<fieldset>
                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td>                                
								<? 
								echo create_drop_down( "cbo_company_name", 262, "select company_name,id from lib_company comp where is_deleted=0  and status_active=1 $company_cond  order by company_name",'id,company_name', 1, '--- Select Company ---', 0, "load_drop_down( 'requires/iron_output_controller', this.value, 'load_drop_down_location', 'location' )" );
								?>
							</td>

							<td width="" class="must_entry_caption">&nbsp;Location</td>
                             <td width="" id="location">
								 <?
								 echo create_drop_down( "cbo_location_name", 262, "select location_name,id from lib_location where is_deleted=0  and status_active=1 order by location_name",'id,location_name', 1, '--- Select Location ---', 0, "load_drop_down( 'requires/iron_output_controller', this.value, 'load_drop_down_store_name', 'store_name' )" );
								 ?>
                             </td>

                          <td width="" class="must_entry_caption">Store Nname</td>
                             <td width="170" id="store_name">
								 <?
                                 echo create_drop_down( "cbo_store_name", 262, "select store_name,id from lib_store_name where is_deleted=0  and status_active=1 order by store_name",'id,location_name', 1, '--- Select Store ---', 0, "" );
                                 ?>
						     </td>
                    ...
                    <tr>
                        ...
                        <td width="25%" valign="top">
                            ...
                            <legend>Display</legend>
                                <table  cellpadding="0" cellspacing="2" width="100%" >
                                    <tr>
                                        <td width="140" id="caption_msg_id">Sewing Output Qty</td>
                                        <td>
