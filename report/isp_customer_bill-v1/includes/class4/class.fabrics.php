...
class fabric extends report{
	...
	// class constructor
	function __construct(condition $condition,$is_sweater=0){
	...
	public function getQtyArray_by_orderAndFabricSource_knitAndwoven_greyAndfinish(){
			$Amount=$this->_setQty_knitAndwoven_greyAndfinish($this->_By_OrderAndFabricSource);
			return $Amount;
		}
