...
//condtion change 3rd step
        if($password == $password2){
            ...
            $sql = "INSERT INTO users(sid,username,dept,batch,email,phone,adress,password,gender,access_control)
             VALUES ('$sid','$username','$dept','$batch','$email','$phone','$adress','$password','$gender','$access_control')";
            mysql_query($sql);
