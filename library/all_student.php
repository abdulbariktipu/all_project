...
<?php
    ...
    if(isset($_POST['update_btn'])){
        ...
        if($query)
        {
           //header('refresh:0; all_student-copy.php');
           //$_SESSION['register_success'] = "Update successfull";         
            $message='<div class="alert alert-success">Update successfull</div>';  
            header("refresh:1; url=all_student.php");            
        }      
           
        else{
            //failed
            //$echo = "Update error";  
            $message='<div class="alert alert-success">Update error</div>'; 
            header("refresh:1; url=all_student.php");
...
<div> 
    <a class='jqbox_innerhtml' href="#">Popup</a>
</div>
-->
