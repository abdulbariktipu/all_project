        ...
        <div class="col-md-12">
			...
			?>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-4">
                          <a onmouseover="bleep.play()" href="all_student.php" class="btn btn-success btn-lg" class="bwidth" role="button"><span class="glyphicon glyphicon-user"></span> <br/>All Student</a>
                         </div> 
                        <div class="col-md-4">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <a onmouseover="bleep.play()" href="all_book.php" class="btn btn-warning btn-lg" class="bwidth" role="button"><span class="glyphicon glyphicon-user"></span> <br/>Book View</a>
                         </div> 
                        <div class="col-md-4">
                          <a onmouseover="bleep.play()" href="book_borrow_view.php" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-user"></span> <br/>Borrow View</a>
                          
                        </div>
                        
                        <div class="col-md-4">
                           <a onmouseover="bleep.play()" href="#" class="btn btn-warning btn-lg" role="button"><span class="glyphicon glyphicon-user"></span> <br/>Demo</a>
                        </div>                   
                    </div>
                </div>
