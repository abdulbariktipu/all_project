<?php
//Note: access control error //if($access==1)
...
$epr='';
  ...
  if(isset($_GET['epr']))
    ...
    if($epr=='delete')
    {
        ...
        $delete=mysql_query(" DELETE FROM book_entry where book_id=$book_id");
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
           ...
           <?php if($access==1){?>                     
            ...
            <li class="active"><a href="all_book.php">Book List</a></li>
...
<div class="container">
        <?php
            if(isset($_SESSION['update_success'])){
                echo "<div id='login_success'>".$_SESSION['update_success']."</div>";
                        ...
                        <div class="col-md-12 col-sm-12">
                          ...
                          <!---------Update Section End------------------>
                                    ...
                                    <td>
                                        ...
                                        <a href='all_book.php?epr=delete&book_id="<?php echo $row["book_id"];?>"'>
