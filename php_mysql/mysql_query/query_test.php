					...
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="dev-table">
    					...
    					<tbody>
                            <?php
                              ...
                              $query=mysql_query("SELECT customerNumber, customerName, addressLine2 FROM customers");
                                ...
                                { 
                                  ?>   
                                      <tr>				
                                        ...
                                        <td>
                                            <a href='edit_file/customerEdit.php?edit=<?php echo $row['customerNumber']; ?>'> Edit </a> | 
