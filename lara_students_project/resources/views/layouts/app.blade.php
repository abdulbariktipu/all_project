        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="/upload/{{ auth()->user()->image_file }}" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/upload/{{ auth()->user()->image_file }}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <img src="/upload/{{ $row->image_file }}" class="img-circle" alt="User" width="160" height="160" />
                @endforeach --}}
                <p>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ route('getProfile') }}" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i><span>Course/Subject</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li><a href=" {{ route('course') }}">Create Course</a></li>
            <li><a href=" {{ route('register') }}">Course List</a></li>
          </ul>
        </li>
        <li><a href=" {{ route('contact') }}"><i class="fa fa-link"></i><span>Contact</span></a></li>
        <li><a href=" {{ route('drag_and_drop') }}"><i class="fa fa-link"></i><span>Drag and Drop</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
