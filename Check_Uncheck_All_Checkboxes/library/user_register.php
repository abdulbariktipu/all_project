...
//condtion change 3rd step
        if($password == $password2){
            //create user
            //$password=md5(mysql_real_escape_string($password)); or
            ...
            $sql = "INSERT INTO users(sid,username,dept,batch,email,phone,adress,password,gender)
             VALUES ('$sid','$username','$dept','$batch','$email','$phone','$adress','$password','$gender')";
            mysql_query($sql);
...
<!-- navbar css -->
			...
			<?php   
				...
				$query0="SELECT * FROM `users` WHERE users.`username`='$user'";
...
<div class="col-md-12 col-sm-12">
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" name="dept" class="form-control input-sm" id="dept" placeholder="Depertment" >
        </div>

		<div class="form-group col-md-6 col-sm-6">
            <label for="batch">Student Batch*</label>
            <input type="text" name="batch" class="form-control input-sm" id="batch" placeholder="Student Batch">
        </div>
		...
		<div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" name="phone" class="form-control input-sm" id="phone" placeholder="Phone Number">
        </div>
		...
		<div class="form-group col-md-6 col-sm-6">
            ...
            <input type="file" name="photo" class="form-control input-sm" id="photo" placeholder="Select Photo">
        </div>  
